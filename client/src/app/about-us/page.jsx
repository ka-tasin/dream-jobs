        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            >
              ...
              small platform has grown into the country&apos;s most trusted
              career destination, serving both job seekers and employers with
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                From our first 100 users to serving millions nationwide,
                we&apos;ve remained committed to our core values: transparency,
                efficiency, and putting people first in the hiring process.
              </p>
      ...
      >
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Whether you&apos;re looking for your dream job or seeking top
